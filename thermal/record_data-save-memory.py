...
def should_skip(domain):
    out_f_path = os.path.join(opts.out_directory,
...
domains = ["resnet18", "resnet34", "resnet50", "resnet101", "resnet152", "vgg11", "vgg13", "vgg16", "vgg19", "vgg11_bn", \
           "vgg13_bn", "vgg16_bn", "vgg19_bn", "shufflenet_v2_05", "shufflenet_v2_10", "shufflenet_v2_15",
           "shufflenet_v2_20", "googlenet", "alexnet", "mobilenet_v3_small", \
           "mobilenet_v2", "mobilenet_v3_large", "squeezenet10", "squeezenet11", "densenet121", "densenet161",
           "densenet169", "densenet201", "mnasnet0_5", "mnasnet0_75", \
